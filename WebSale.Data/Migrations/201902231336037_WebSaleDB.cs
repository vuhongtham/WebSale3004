namespace WebSale.Data.Migrations
{
    ...
    public partial class WebSaleDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Tables", t => t.TagID, cascadeDelete: true)
                .Index(t => t.PostID)
                .Index(t => t.TagID);
        ...
        {
            DropForeignKey("dbo.ProductTags", "TagID", "dbo.Tables");
            DropForeignKey("dbo.ProductTags", "ProductID", "dbo.Products");
            DropForeignKey("dbo.PostTags", "TagID", "dbo.Tables");
