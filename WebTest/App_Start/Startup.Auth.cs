...
[assembly: OwinStartup(typeof(WebSale.Web.App_Start.Startup))]

namespace WebSale.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(WebSaleDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<WebSaleDbContext>());
